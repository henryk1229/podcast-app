...
# end
#
# response = RestClient.get("https://listen-api.listennotes.com/api/v2/best_podcasts?genre_id=80",
#       {"X-ListenAPI-Key": "96b204f3687d4e9998e5d2206af928ae",
#         accept: :json
#       })
# response_data = JSON.parse(response)
...
# end
#
# response = RestClient.get("https://listen-api.listennotes.com/api/v2/best_podcasts?genre_id=44",
#       {"X-ListenAPI-Key": "96b204f3687d4e9998e5d2206af928ae",
#         accept: :json
#       })
# response_data = JSON.parse(response)
...
# end
#
# response = RestClient.get("https://listen-api.listennotes.com/api/v2/best_podcasts?genre_id=97",
#       {"X-ListenAPI-Key": "96b204f3687d4e9998e5d2206af928ae",
#         accept: :json
#       })
# response_data = JSON.parse(response)
...
# end
#
# response = RestClient.get("https://listen-api.listennotes.com/api/v2/best_podcasts?genre_id=88",
#       {"X-ListenAPI-Key": "96b204f3687d4e9998e5d2206af928ae",
#         accept: :json
#       })
# response_data = JSON.parse(response)
...
# end
#
# response = RestClient.get("https://listen-api.listennotes.com/api/v2/best_podcasts?genre_id=77",
#       {"X-ListenAPI-Key": "96b204f3687d4e9998e5d2206af928ae",
#         accept: :json
#       })
# response_data = JSON.parse(response)
...
# end
#
# response = RestClient.get("https://listen-api.listennotes.com/api/v2/best_podcasts?genre_id=71",
#       {"X-ListenAPI-Key": "96b204f3687d4e9998e5d2206af928ae",
#         accept: :json
#       })
# response_data = JSON.parse(response)
